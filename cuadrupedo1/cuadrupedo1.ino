...
int home_frh = 90+20; //poscición inicial de la cadera derecha frontal
int home_frl = 90; //poscición inicial de la pata derecha frontal
int home_flh = 90-20; //poscición inicial de la cadera izquierda frontal
int home_fll = 90; //poscición inicial de la pata izquierda frontal
int home_rrh = 90-20; //poscición inicial de la cadera derecha tracera 
int home_rrl = 90; //poscición inicial de la pata derecha tracera
int home_rlh = 90+20; //poscición inicial de la cadera izquierda tracera
...
//Funcion para que avance el cuadrúpedo
void Avanzar(){
   for(int i=0; i<5; i++) {
...
//Funcion para que retroceda el cuadrúpedo
void Retroceder(){
   for(int i=0; i<5; i++) {
...
//Funcion para que gire a la derecha el cuadrúpedo
void Girar_derecha(){
   for(int i=0; i<6; i++) {
      rll.write(home_rll+50);
      delay(200);
...
//Funcion para que gire a la izquierda el cuadrúpedo
